...
{
    [TestClass]
    public class A_SyncAppNativeAPIInputGenerator
    {
        
        public A_SyncAppNativeAPIInputGenerator()
        {
        ...
        public void A_SyncAppNativeMainMethodInputGenerator()
        {
            ...
            QueryArrayAllAPI.queryArrayAllAPI[0] = Utils.ExcelUtil.ReadData(4, "Query") + " " + Utils.ExcelUtil.ReadData(1, "Limit");
            QueryArrayAllAPI.queryArrayAllAPI[1] = Utils.ExcelUtil.ReadData(4, "sdkVersion") + " " + Utils.ExcelUtil.ReadData(1, "Limit");
            QueryArrayAllAPI.queryArrayAllAPI[2] = Utils.ExcelUtil.ReadData(4, "adID");
            QueryArrayAllAPI.queryArrayAllAPI[3] = Utils.ExcelUtil.ReadData(4, "failOverAdIDBanner");
            QueryArrayAllAPI.queryArrayAllAPI[4] = Utils.ExcelUtil.ReadData(4, "failOverAdIDNative");
            QueryArrayAllAPI.queryArrayAllAPI[5] = Utils.ExcelUtil.ReadData(4, "failOverAdIDRewardedVideo");
            Extension.ExecuteQueryAPICodeGenerator(SqlConnectionInstance.SqlConnection, dataSetIndex);
            CreateJsonRequestInputGenerator.CreateJson(DataSetPropertyFill.dataSetPropertyFill, "SyncAppNative");
        }
    }
}