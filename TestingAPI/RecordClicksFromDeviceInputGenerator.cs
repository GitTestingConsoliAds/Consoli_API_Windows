...
namespace Monetization_Automation.Test
{
    ...
    public class RecordClicksFromDeviceInputGenerator
    {
        ...
        public void RecordClicksFromDeviceMainMethodCodeGenerator()
        {
            ...
            QueryArrayAllAPI.queryArrayAllAPI[0] = Utils.ExcelUtil.ReadData(7, "Query") + " " + Utils.ExcelUtil.ReadData(1, "Limit"); 
            QueryArrayAllAPI.queryArrayAllAPI[1] = Utils.ExcelUtil.ReadData(7, "AppKey") + " " + Utils.ExcelUtil.ReadData(1, "Limit");
            Extension.ExecuteQueryAPICodeGenerator(SqlConnectionInstance.SqlConnection, dataSetIndex);
            CreateJsonRequestInputGenerator.CreateJson(DataSetPropertyFill.dataSetPropertyFill, "RecordClicksFromDevice");
            Thread.Sleep(2000);
        }
    }
}