...
{
    [TestClass]
    public class recordBroadCastInstallAPI
    {
        
        public recordBroadCastInstallAPI()
        {
            try
            {
                if (ExcelUtil._dataCollection.Count == 0)
                {
                    ...
                    if (directoryInfo != null)
                    {
                        ...
                        {
                            ExcelUtil.PopulateInCollection(@"/Volumes/DataDisk/Ahmad khisal/Consoliads/Automation_Data/APIExcels/ALLAPI.xlsx", "recordBroadCastInstall");
                        }
                    }
                }
            }
        ...
        public void recordBroadCastInstallMainMethod()
        {
            ...
            foreach (System.Data.DataRow row in DataTableCollectionLoop.tableCollection.Rows)
            {
                ...
                SendJsonRequest.SendJsonRequestMainMethod(jSonbody, URL, request, count,"RecordBraodCastInstall");
                count = count - 1;
            }
        }
    }
