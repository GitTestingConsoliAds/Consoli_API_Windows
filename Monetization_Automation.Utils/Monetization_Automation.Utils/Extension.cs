...
namespace Monetization_Automation.Utils
{
    ...
    public static class Extension
    {
        ...
        public static void CreateLogFile(int serialNumber, string jsonRequest, string jsonResponse, string Status,string Name, string URL)
        {
            ...
            string fileName = @"E:\Automation\Automation_API_Windows\Monetization_Automation\Monetization_Automation\Monetization_Automation\" + logFileName + Name + ".htm";
            ...
            if (!File.Exists(fileName))
            {
                ...
                //Table end.
                html += "</table>";
                File.WriteAllText(@"E:\Automation\Automation_API_Windows\Monetization_Automation\Monetization_Automation\Monetization_Automation\" + logFileName +  Name + ".htm", html);
               // Console.ReadLine();
            }
            else
            {
                ...
                //Table end.
                html += "</table>";
                File.AppendAllText(@"E:\Automation\Automation_API_Windows\Monetization_Automation\Monetization_Automation\Monetization_Automation\" + logFileName + Name + ".htm", html);
                //Console.ReadLine();
            }
